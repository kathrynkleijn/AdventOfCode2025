...
class TachyonManifold:
    ...
    # take splitter.
    # Is there a splitter directly above it? If yes, remove
    # Otherwise:
    # is there a splitter on either side on row above? If not:
    #           is there a splitter directly above on the next row? If yes, remove
    #           Otherwise:
    #           is there a splitter on either side on the next row above?
    ...
    #
    #
    # if col in splitter_dict[row-2]:
    #   remove
    # else:
    # if col-1 or col+1 in splitter_dict[row-2]:
    #       log this somehow as "connected" and move onto next column
    # if not above:
    #       if col in splitter_dict[row-4]:
    #           etc etc.
...
print(test_manifold2.beam_step_through())
...
# answer_manifold = TachyonManifold(input_data, debug=True)
